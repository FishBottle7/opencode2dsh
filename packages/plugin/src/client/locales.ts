...
export const zh = {
  ...
  probeModelsHint: '每行一个模型 id；留空 = 默认 big-pickle。同一出口内多模型串行探测。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  refillCountFetched: '{n} rows fetched',
  ...
  probeModelsHint: 'One model id per line; empty = default big-pickle. Multiple models stay serial per exit.',
